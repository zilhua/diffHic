...
y.small$offset <- normalizeChIP(counts(smaller.data), 
    lib.sizes=totals(smaller.data), type="loess")
...
Of course, this bin clustering method will not be optimal for diffuse interactions.
